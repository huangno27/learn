...
class Car():
    ...
    def read_odometer(self): #新定义一个方法 能够轻松获悉汽车里程（读取初始值的方法）
        print("This car has " + str(self.odometer_reading) + " miles on it")

    def update_odometer(self, mileage):
        print(str(self.odometer_reading = mileage))

    #3 通过方法递增修改属性值
    #3-3def increment_odometer(self, miles):
        #3-3"""将里程表读书增加特定的值"""
        #3-3self.odometer_reading += miles

#3-3my_userd_car = Car('infiniti', 'outback', '2013')
#3-3print(my_userd_car.get_desc_name())

#3-3my_userd_car.update_odometer(23500)
#3-3my_userd_car.read_odometer()

#3-3my_userd_car.increment_odometer(100)
#3-3my_userd_car.read_odometer()
...
#2-1 my_new_car.update_odometer(25)
#2-2 my_new_car.read_odometer()



#修改属性的值 有三种方法：直接通过实例进行修改，通过方法进行修改，通过方法进行递增（增加特定的值）
#1.直接修改属性的值
my_new_car.read_odometer = 23
my_new_car.read_odometer()
#2.通过方法进行修改属性的值
#2.添加一个方法
def updeat_odometer(self,mileage):
...
def updeat_odometer(self,mileage):
    """设定特定的值 禁止进行修改"""
    if mileage >= self3.odometer_reading
        self.odometer_reading = mileage
    else:
        print("your can't roll back odometer")
...
my_userd_car = Car('infiniti','outback','2013')
print(my_userd_car.get_desc_name())
